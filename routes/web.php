...
use App\Http\Controllers\FrontEndHtml\PortfolioHomeController;
...
/* FrontEndHtml - Portfolio */
Route::get('/frontendhtml/portfoliohome', [PortfolioHomeController::class, 'index'])->name('portfoliohome');
