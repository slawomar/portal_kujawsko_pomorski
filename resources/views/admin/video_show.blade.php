...
@section('button')
<a href="{{ route('admin_video_create') }}" class="btn btn-primary"><i class="fas fa-plus"></i>Dodaj</a>
@endsection
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="pt_10 pb_10">
                                        <a href="{{ route('admin_video_edit',$row->id) }}" class="btn btn-primary">Edycja</a>
                                        <a href="{{ route('admin_video_delete',$row->id) }}" class="btn btn-danger" onClick="return confirm('Are you sure?');">Usuń</a>
                                    </td>   
                                </tr>
                                @endforeach
                            </tbody>
