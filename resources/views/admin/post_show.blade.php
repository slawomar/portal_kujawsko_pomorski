                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="pt_10 pb_10">
                                        {{-- warunek na wyświetlanie lub brak przycisku delete i edit dla autora w liście artykułów --}}
                                        @if($row->admin_id!=0)
                                        <a href="{{ route('admin_post_edit',$row->id) }}" class="btn btn-primary">Edycja</a>
                                        <a href="{{ route('admin_post_delete',$row->id) }}" class="btn btn-danger" onClick="return confirm('Are you sure?');">Usuń</a>
                                        @endif
                                    </td>   
                                </tr>
                                @endforeach
