...
@section('heading', 'Edycja Strony Zastrzeżeń')
            ...
            <div class="card">
                <div class="card-body">  
                    <div class="form-group mb-3">
                        <label>Tytuł *</label>
                        <input type="text" class="form-control" name="disclaimer_title" value="{{ $page_data->disclaimer_title}}">
                    </div>
                    <div class="form-group mb-3">
                        <label>Szczegóły *</label>
                        <textarea name="disclaimer_detail" class="form-control snote" id="" cols="30" rows="10">{{ $page_data->disclaimer_detail }}</textarea>
                    </div>
                    <div class="form-group mb-3">
                        <label>Status?</label>
