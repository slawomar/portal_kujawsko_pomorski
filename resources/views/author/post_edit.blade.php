...
@section('button')
<a href="{{ route('author_post_show') }}" class="btn btn-primary"><i class="fas fa-eye"></i>Widok</a>
@endsection
            ...
            <div class="card">
                <div class="card-body">  
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea name="post_detail" class="form-control snote" cols="30" rows="10">{{ $post_single->post_detail }}
                        </textarea>
                    </div>
                    <div class="form-group mb-3">
