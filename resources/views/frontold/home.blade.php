                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            <input type="text" name="text_item" class="form-control" placeholder="Treść Opisu">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
        ...
        <div class="row">
            <div class="col-lg-8 col-md-6 left-col">
                <div class="left">
                    ...
                    {{-- wyswietlanie kategorii postu --}}
                    @foreach($sub_category_data as $item)

                    {{-- warunek jeśli brak postów z kategorii nie wyświetlaj kategorii na stronie glownej --}}
                     ...
                     <div class="news-total-item">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-12 see-all">
                                <a href="{{ route('category',$item->id) }}" class="btn btn-primary btn-sm">Wszystkie artykuły</a>
                            </div>
                            <div class="col-md-12">
                                <div class="bar"></div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            @foreach($item->rPost as $single) 
                                ...
                                <div class="col-lg-6 col-md-12">
                                    <div class="left-side">
                                        ...
                                        {{-- klasa skracająca artykuł do początkowego akapitu, jest w public/dist-front/css/style.css --}}
                            ...
                            {{-- col-lg-5 zamiast col-lg-6 odstep miedzy zdjeciami w kategoriach postow --}}
                            <div class="col-lg-6 col-md-12">
            ...
            <div class="col-md-12">
                <div class="video-carousel owl-carousel">
                    @foreach($video_data as $item)
                        {{-- ile filmów wyświetla się w pasku dolnym, zgodnie z ustawieniem w panelu admina - setting --}}
...
{{-- skrypt Ajax do dzialania kategorii wyszukiwania na stronie glownej, wybor podkategorii wynika z kategorii, kontroler Front/HomeController --}}
<script>
    (function($){
