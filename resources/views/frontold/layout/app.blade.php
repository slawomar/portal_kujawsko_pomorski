...
<html lang="en">
    <head>
        ...
        <title>Regionalny Portal Kujawsko-Pomorski</title>        
    ...
    <body>
        <div class="top">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <ul>
                            <li class="today-text">Dzisiaj: 22 sierpnia 2022</li>
                            <li class="email-text">contact@webmaster.com</li>
                        </ul>
                    </div>
                    <div class="col-md-6">
                        <ul class="right">
                    ...
                    <div class="col-md-3">
                        <div class="item">
                            ...
                            <p>
                             ...
                             {{-- klasa form_contact_ajax byla już w contact.blade.php --}}
        ...
        <div class="copyright">
            Copyright 2022, Webmaster. All Rights Reserved.
        </div>
