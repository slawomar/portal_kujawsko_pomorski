...
<div class="page-top">
    <div class="container">
        <div class="row">
            <div class="col-md-12"> 
                <h2>Tagi ze wszystkich artykułów: {{ $tag_name }}</h2>
                <nav class="breadcrumb-container">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('home') }}">Start</a></li>
                        <li class="breadcrumb-item">TAGI</li>
            ...
            <div class="col-lg-8 col-md-6">
                ...
                <div class="category-page">
                    <div class="row">
                        ...
                        @endforeach
                        @else
                        <span class="text-danger">Nie znaleziono artykułu</span>
                        @endif

                        {{-- paginacja na stronie dla artykułów --}}
                        {{-- <div class="col-md-12">
                            {{ $all_posts->links() }}
                        </div> --}}
