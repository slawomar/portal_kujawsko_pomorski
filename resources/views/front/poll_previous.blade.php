...
<div class="page-top">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2>Poprzednie głosowania</h2>
                <nav class="breadcrumb-container">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('home') }}">Start</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Poprzednie głosowania</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                @foreach($online_poll_data as $item)
                    {{-- w poprzednich głosowaniach nie pokazuję ostatniego  --}}
                @if($loop->iteration == 1)
                        @continue
                    @endif
                    @php
                ...
                <div class="poll-item">
                    ...
                    <div class="poll-date">
                        ...
                        @endphp
                        <b>Data sondy:</b> {{ $updated_date }}
                    </div>
                    <div class="total-vote">
                        <b>Wynik końcowy:</b> {{ $total_vote }}
                    </div>
                    <div class="poll-result">                        
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                <tr>
                                    <td>Tak ({{ $item->yes_vote }})</td>
                                    <td>
                                        <div class="progress">
