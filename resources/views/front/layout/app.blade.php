				...
				<div class="owl-wrapper">
					<div class="owl-carousel" data-num="4">
						...
						<div class="item">
							<div class="news-post image-post">
								<div class="post-gallery">
									<img src="{{ asset('dist-front/upload/news-posts/h9.jpg') }}" alt="">
									<div class="hover-box">
						...
						<div class="item">
							<div class="news-post image-post">
								<div class="post-gallery">
									<img src="{{ asset('dist-front/upload/news-posts/h10.jpg') }}" alt="">
									<div class="hover-box">
										<div class="inner-hover">
						...
						<div class="item">
							<div class="news-post image-post">
								<div class="post-gallery">
									<img src="{{ asset('dist-front/upload/news-posts/h11.jpg') }}" alt="">
									<div class="hover-box">
										<div class="inner-hover">
											<a class="category-post" href="game-category.html">action</a>
						...
						<div class="item">
							<div class="news-post image-post">
								<div class="post-gallery">
									<img src="{{ asset('dist-front/upload/news-posts/h12.jpg') }}" alt="">
									<div class="hover-box">
										<div class="inner-hover">
						...
						<div class="block-content">
							...
							<div class="grid-box">
								...
								<div class="news-post standard-post2">
									<div class="post-gallery">
										<img src="{{ asset('dist-front/upload/news-posts/1.jpg') }}" alt="">
										<div class="rate-level">
								...
								<div class="row">
									<div class="col-md-6">
										<ul class="list-posts">
											<li>
												<img src="{{ asset('dist-front/upload/news-posts/list1.jpg') }}" alt="">
											...
											<li>
												<img src="{{ asset('dist-front/upload/news-posts/list2.jpg') }}" alt="">
												<div class="post-content">
													<h2><a href="single-post.html">Pellentesque odio nisi, euismod in, pharetra a, ultricies in, diam. </a></h2>
													<ul class="post-tags">
														<li><i class="fa fa-clock-o"></i>27 may 2013</li>
											...
											<li>
												<img src="{{ asset('dist-front/upload/news-posts/list3.jpg') }}" alt="">
												<div class="post-content">
													<h2><a href="single-post.html">Pellentesque odio nisi, euismod in, pharetra a, ultricies in, diam. </a></h2>
													<ul class="post-tags">
														<li><i class="fa fa-clock-o"></i>27 may 2013</li>
									...
									<div class="col-md-6">
										<ul class="list-posts">
											<li>
												<img src="{{ asset('dist-front/upload/news-posts/list4.jpg') }}" alt="">
												<div class="post-content">
													<h2><a href="single-post.html">Pellentesque odio nisi, euismod in, pharetra a, ultricies in, diam. </a></h2>
													<ul class="post-tags">
														<li><i class="fa fa-clock-o"></i>27 may 2013</li>
											...
											<li>
												<img src="{{ asset('dist-front/upload/news-posts/list5.jpg') }}" alt="">
												<div class="post-content">
													<h2><a href="single-post.html">Pellentesque odio nisi, euismod in, pharetra a, ultricies in, diam. </a></h2>
													<ul class="post-tags">
														<li><i class="fa fa-clock-o"></i>27 may 2013</li>
											...
											<li>
												<img src="{{ asset('dist-front/upload/news-posts/list6.jpg') }}" alt="">
												<div class="post-content">
													<h2><a href="single-post.html">Pellentesque odio nisi, euismod in, pharetra a, ultricies in, diam. </a></h2>
													<ul class="post-tags">
														<li><i class="fa fa-clock-o"></i>27 may 2013</li>
							...
							<div class="advertisement">
								<div class="desktop-advert">
									...
									<img src="{{ asset('dist-front/upload/addsense/728x90-white.jpg') }}" alt="">
								</div>
								<div class="tablet-advert">
									<span>Advertisement</span>
									<img src="{{ asset('dist-front/upload/addsense/468x60-white.jpg') }}" alt="">
								</div>
					...
					<div class="slider-caption-box">
							...
							<ul class="slider-call">
								<li>
									<div class="news-post iframe-post">
										<!-- Vimeo -->
										<iframe class="videoembed" src="http://player.vimeo.com/video/76856850?title=0&amp;byline=0&amp;portrait=0" frameborder="0" webkitallowfullscreen="" mozallowfullscreen="" allowfullscreen=""></iframe>
										<!-- End Vimeo -->
									</div>
								</li>
								<li>
									<div class="news-post image-post">
										<!-- Vimeo -->
										<iframe class="videoembed" src="http://player.vimeo.com/video/131892249?title=0&amp;byline=0&amp;portrait=0" frameborder="0" webkitallowfullscreen="" mozallowfullscreen="" allowfullscreen=""></iframe>
										<!-- End Vimeo -->									
									</div>
								</li>
								<li>
									<div class="news-post image-post">
										<!-- Vimeo -->
										<iframe class="videoembed" src="http://player.vimeo.com/video/38903952?title=0&amp;byline=0&amp;portrait=0" frameborder="0" webkitallowfullscreen="" mozallowfullscreen="" allowfullscreen=""></iframe>
										<!-- End Vimeo -->	
									</div>
								</li>
								<li>
									<div class="news-post image-post">
										<!-- Vimeo -->
										<iframe class="videoembed" src="http://player.vimeo.com/video/88887227?title=0&amp;byline=0&amp;portrait=0" frameborder="0" webkitallowfullscreen="" mozallowfullscreen="" allowfullscreen=""></iframe>
										<!-- End Vimeo -->
									</div>
								</li>
								<li>
									<div class="news-post image-post">
										<!-- Vimeo -->
										<iframe class="videoembed" src="http://player.vimeo.com/video/63942137?title=0&amp;byline=0&amp;portrait=0" frameborder="0" webkitallowfullscreen="" mozallowfullscreen="" allowfullscreen=""></iframe>
										<!-- End Vimeo -->
									</div>
								</li>
							</ul>
						...
						<div id="bx-pager">
							<a data-slide-index="0" href="">
								<img src="{{ asset('dist-front/upload/news-posts/thumb1.jpg') }}" alt="">
								Aliquam porttitor mauris sit amet orci. Aenean dignissim pellentesque
								<span>Action-Adventure NDS, Nintendo Wii</span>
							</a>
							<a data-slide-index="1" href="">
								<img src="{{ asset('dist-front/upload/news-posts/thumb2.jpg') }}" alt="">
								Morbi in sem quis dui placerat ornare. 
								<span>Action-Adventure NDS, Nintendo Wii</span>
							</a>
							<a data-slide-index="2" href="">
								<img src="{{ asset('dist-front/upload/news-posts/thumb3.jpg') }}" alt="">
								Pellentesque odio nisi, euismod in, pharetra a, ultricies in, diam.  
								<span>Action-Adventure NDS, Nintendo Wii</span>
							</a>
							<a data-slide-index="3" href="">
								<img src="{{ asset('dist-front/upload/news-posts/thumb4.jpg') }}" alt="">
								Pellentesque odio nisi, euismod in, pharetra a, ultricies in, diam.. 
								<span>Action-Adventure NDS, Nintendo Wii</span>
							</a>
							<a data-slide-index="4" href="">
								<img src="{{ asset('dist-front/upload/news-posts/thumb5.jpg') }}" alt="">
								Morbi in sem quis dui placerat ornare. 
								<span>Action-Adventure NDS, Nintendo Wii</span>
							</a>
						</div>
							...
							<div class="col-md-6">
								...
								<ul class="list-posts">
									...
									<li>
										<img src="{{ asset('dist-front/upload/news-posts/list5.jpg') }}" alt="">
										<div class="post-content">
											<h2><a href="single-post.html">Nam dui mi, tincidunt quis, accumsan porttitor, facilisis luctus, metus.</a></h2>
											<ul class="post-tags">
												<li><i class="fa fa-clock-o"></i>27 may 2013</li>
												<li><i class="fa fa-user"></i>by <a href="#">John Doe</a></li>
												<li><a href="#"><i class="fa fa-comments-o"></i><span>23</span></a></li>
									...
									<li>
										<img src="{{ asset('dist-front/upload/news-posts/list6.jpg') }}" alt="">
										<div class="post-content">
											<h2><a href="single-post.html">Nullam malesuada erat ut turpis. Suspendisse urna nibh, viverra non, semper suscipit, posuere a, pede.</a></h2>
											<ul class="post-tags">
												<li><i class="fa fa-clock-o"></i>27 may 2013</li>
												<li><i class="fa fa-user"></i>by <a href="#">John Doe</a></li>
												<li><a href="#"><i class="fa fa-comments-o"></i><span>23</span></a></li>
